...
$$
where $|A|$ denotes the number of elements of the set $A$, $H$ is the value defined in (4.6.1) and $\mathbf{w}=(w_1,w_2,w_3)$ is the vector of weights ($e$ is, of course, the base of the natural logarithm). This measure has all above mentioned properties.
