...
$$
where $x_{i(\text{max})}$ is the share of the largest contributors to the cell $C_i$ and $x_j$ is the contribution of the $j$-th unit to it. This measure tales value from $[0,1]$ and is easy interpretable.    
