...
or
$$d({x_{ij}}^{\prime},x_{ij})=({x_{ij}}^{\prime}-x_{ij})^2/\max_(k=1,2,\dots,n)⁡({x_{kj}}^{\prime}-x_{kj})^2,$$ (3.5.10)
...
\max\limits_{h=1,2,\ldots,n}{x_{hj}}&\text{if}\quad x_{ij}\le\med_{h=1,2,\ldots,n}{x_{hj}},\\
\min\limits_{h=1,2,\ldots,n}{x_{hj}}&\text{if}\quad x_{ij}>\med_{h=1,2,\ldots,n}{x_{hj}}.
\end{cases}
$$
