...
$$
where $\mathfrak{r}(x_{ij}}^',x_{hj})$ is the absolute difference in categories between $x_{ij}}^'$ and $x_{hj}$ and $\mathfrak{r}_j$ is the total number of categories of $X_j$.These partial distances take always values from [0,1].  

Much more complicated situation occurs for continuous variables.
