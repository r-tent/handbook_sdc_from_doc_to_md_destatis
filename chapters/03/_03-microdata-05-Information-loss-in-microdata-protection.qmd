...
Straightforward computation of measures based on most descriptive statistics (Euclidean distace, mean, variance, correlation, etc.) on categorical data is not possible. The following alternatives are considered in Domingo-Ferrer and Torra (2001):
• direct comparison of categorical values,
• comparison of contingency tables,
• entropy-based measures.

Below we will describe each of such types of measure.
