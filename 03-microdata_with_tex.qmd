...
> In (Domingo-Ferrer and González-Nicolás, 2009) an alternative procedure to generate hybrid data based on microaggregation was proposed. Let *V* be an original data set consisting of *n* records. On input an integer parameter![](Images/media/image111.png){width="0.7708333333333334in" height="0.25in"}, the procedure described in this section generates a hybrid data set ![](Images/media/image112.png){width="0.13541666666666666in" height="0.25in"}. The greater *k*, the more synthetic is ![](Images/media/image113.png){width="0.13541666666666666in" height="0.25in"}. Extreme cases are: i) *k* = 1, which yields ![](Images/media/image114.png){width="0.13541666666666666in" height="0.25in"} = *V* (the output data are exactly the original input data); and ii) *k* = *n*, which yields a completely synthetic output data set ![](Images/media/image115.png){width="0.13541666666666666in" height="0.25in"}.![](Images/media/image116.png){width="0.2in" height="0.2in"}
>
...
![](Images/media/image131.png){width="1.6909722222222223in" height="0.6256944444444444in"}
