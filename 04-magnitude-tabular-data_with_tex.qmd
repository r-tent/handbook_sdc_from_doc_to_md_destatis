...
![Overview of the τ‑ARGUS architecture](Images/media/tau_argus_overview.png){#fig-tau-argus-overview}
...
### Setting up a Tabular Data Protection Problem in Practice {#setting-up-a-tabular-data-protection-problem-in-practice}
...
### Evaluation of Secondary Cell Suppression algorithms offered by τ‑ARGUS {#evaluation-of-secondary-cell-suppression-algorithms-offered-by-τargus}
...
We compare the loss of information due to secondary suppression in terms of the number and cell values of secondary suppression, and analyze the disclosure risk of the protected tables. @tbl-results-study-A reports the results regarding the loss of information obtained in study A.
...
+------+------+----------+-----------+---------+-----------+---------+
|   2  |   4  |   1050   |   10.95   |   8.29  |    0.98   |   0.62  |
+------+------+----------+-----------+---------+-----------+---------+
|   3  |   6  |   8230   |   14.92   |  11.48  |    6.78   |   1.51  |
+------+------+----------+-----------+---------+-----------+---------+
|   4  |   7  |   16530  |   14.97   |  11.13  |    8.24   |   2.12  |
+------+------+----------+-----------+---------+-----------+---------+
|                        3-dimensional tables                        |
+------+------+----------+-----------+---------+-----------+---------+
|   5  |   3  |   8280   |   14.63   |  10.72  |    6.92   |   1.51  |
+------+------+----------+-----------+---------+-----------+---------+
|   6  |   4  |   18900  |   17.31   |  15.41  |   12.57   |   3.55  |
+------+------+----------+-----------+---------+-----------+---------+
|   7  |   6  |  148140  |   15.99   |  10.63  |   23.16   |   3.91  |
+------+------+----------+-----------+---------+-----------+---------+
...
: Results of study B - Number and value of secondary suppression {#tbl-res-B}
