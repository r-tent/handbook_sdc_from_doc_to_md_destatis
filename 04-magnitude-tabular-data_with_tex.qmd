...
Table 4.1 briefly presents the most common sensitivity rules. Throughout this chapter we denote $x_{1} \geq x_{2} \geq \text{.}\text{.}\text{.} \geq x_{N}$ the ordered contributions by respondents 1,2,...,*N*, respectively, to a cell with cell total (or cell value) $X = \sum_{i \leq N}^{}x_{i}$
