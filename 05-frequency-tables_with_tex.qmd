...
@tbl-mar-hours below shows respondents in a particular area broken down by hours worked and income.
...
: Single Person households and hours worked in Area A (2001OA definition) {#tbl-single-hh-hours}
...
: Single Person households and income band in Area A (1991 ED definition) {#tbl-single-hh-income}
...
A fictitious example of disclosure by linking is provided below in @tbl-residence-workplace to @tbl-differenced-table-linking, which are linked by employment status and whether or not the respondents live in the area.
